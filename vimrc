...
highlight ColorColumn ctermbg=19 ctermfg=white
highlight CursorLineNr cterm=bold ctermfg=25
highlight LineNr ctermfg=21
highlight String cterm=none ctermfg=82
highlight MatchParen cterm=bold ctermbg=19
highlight Comment ctermfg=25
highlight CursorLine cterm=none ctermbg=233
highlight Search cterm=bold ctermfg=16 ctermbg=103
